...
import { currentUserId, sendMagicLink, signInForTest } from '@/lib/supabase-auth';
...
export function AuthGate({ children }: { children: React.ReactNode }) {
  ...
  useEffect(() => {
    void currentUserId().then((id) => { setSignedIn(Boolean(id)); setReady(true); });
  }, []);
